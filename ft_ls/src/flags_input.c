...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/21 14:17:10 by cchieko           #+#    #+#             */
/*   Updated: 2019/12/21 14:17:16 by cchieko          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	clean_flag_list(char **dirty_flags)
{
	...
	if (!(clean_flags = ft_strnew(11)))
		crush_and_error(ERROR_MSG, NULL, dirty_flags);
...
void	flag_args_to_flags(char ***flag_args, char **flags)
{
	...
	while ((*flag_args)[++i])
		...
		else
		{
			...
			free_flag_arguments(flag_args);
			crush_and_error(NULL, NULL, flags);
		}
}
