...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/23 15:30:23 by cchieko           #+#    #+#             */
/*   Updated: 2019/12/26 18:28:00 by cchieko          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_ls.h"

int				fill_file_stat_sq(t_file_stats **file_stat,
...
t_file_stats	*new_file_stat(char *path, char *name)
{
	...
	if (!(file_stat = (t_file_stats*)malloc(sizeof(t_file_stats))))
		return (NULL);
